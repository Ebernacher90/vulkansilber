...
SchwalbiniPokedexEntry:: INCLUDE "data/pokemon/dex_entries/gold/schwalbini.asm"
SchwalbossPokedexEntry:: INCLUDE "data/pokemon/dex_entries/gold/schwalboss.asm"
